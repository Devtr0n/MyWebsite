...
namespace RichardHollonSite.Helpers
{
    public class YouTubeVideoHelper
    {
        ...
        const string YOUTUBE_VIDEO_COUNT = "50";
        ...
        public static YouTubeVideoObject[] GetVideos()
        {
            ...
            string feedUrl = String.Format("http://gdata.youtube.com/feeds/api/users/{0}/uploads?max-results={1}&orderby=published", YOUTUBE_CHANNEL, YOUTUBE_VIDEO_COUNT);
